class Post < Airrecord::Table
  ...
  def essay!
    post = self
    prompt = "Turn this podcast transcript into a markdown-formatted essay, as if by a listener of the podcast, with a ## header for each topic covered. Don't mention that you're a listener.\n\n#{post['Wizper transcript']}"
